...
<body style="background: #f2f2f2; font-family: 'Montserrat', sans-serif">
    <div>
        <div style="text-align: center; margin-top: 40px; margin-bottom: 40px;">
            <img src="https://auth.boostedtechs.com/assets/app_icons/academy.png" style="width:200px" alt="logo">
        </div>
        <div style="width:100%; max-width: 600px; margin: auto; background: white; padding: 15px; text-align: left; border-radius: 5px; border-top: 4px solid #007bff;">
            <div>{$message}</div>
        </div>
        <div style="width: 95%; max-width: 600px; margin: auto; margin-top: 10px; margin-bottom: 40px; padding: 10px; text-align: center; color:#aaaaaa">
            ...
            <p>Boosted Academy is a product of  <a href="//{$smarty.server.SERVER_NAME}">Boosted Technologies</a></p>
            ...
            <a href="https://devmate.boostedtechs.com">
                ...
                <img src="https://auth.boostedtechs.com/assets/app_icons/academy.png" style="width:80px" alt="logo">
        </div>
            </a>
        </div>
    </div>
