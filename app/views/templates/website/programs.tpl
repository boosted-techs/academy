...
{block name="meta"}
    <title>Programs: Boosted Academy</title>
    ...
    <meta name="description" content="Amazing Practical course outline, professional programs in computer science and information technology, employment for the best students!">
    ...
    <meta property="og:description" content="Amazing Practical course outline, professional programs in computer science and information technology, employment for the best students!">
                        ...
                        <div class="title-holder">
                            <div class="title-holder-cell text-left">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">Programs Page</li>
                                </ol>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 mx-auto">
                    <h1 class="p-4">Our Amazing Programs</h1>
                    <div class="full">
                            ...
                            <div class="blog_section">
                                ...
                                <div class="blog_feature_cantant">
                                    ...
                                    <div class="bottom_info">
                                        <div class="pull-left"><a class="btn sqaure_bt" href="//{$smarty.server.SERVER_NAME}/program/{$program.url}">Read More<i class="fa fa-angle-right"></i></a></div>
